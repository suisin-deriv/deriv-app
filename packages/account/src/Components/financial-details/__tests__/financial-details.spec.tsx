...
import FinancialDetails, { TFinancialInformationAndTradingExperience } from '../financial-details';
import { TFinancialDetails } from '../../types/common.types';
...
describe('<FinancialDetails />', () => {
    ...
    it('should render "FinancialDetails" for desktop', () => {
        ...
        expect(screen.queryByTestId('dt_form_submit_button')).toBeInTheDocument();
